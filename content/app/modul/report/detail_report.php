...
$t=mysqli_query($conn, "select *from ncir_c");
$a = mysqli_query($conn, "select *from ncir_inspection ni left join ncir_correction nc on ni.ncirCode=nc.ncirCode left join ncir_correction_type nct on nc.idCor=nct.idCor  left join departemen d on ni.tujuan=d.idDepart where ni.ncirCode='$_GET[no]'");
...
<h5>DETAIL REPORT NCIR</h5><br><br>
</div>
<?php
echo"
...
<tr>
	<td><font size='2'>&nbsp;</font></td>
		<td>:</td>
		<td>
		<input type='checkbox' style='height:16px;width:16px;background-color:none border:2px' disabled=''><font size='2'> Critical</font>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type='checkbox' style='height:16px;width:16px;background-color:none border:2px' disabled=''><font size='2'> Minor</font>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type='checkbox' style='height:16px;width:16px;background-color:none border:2px' disabled=''><font size='2'> Major</font>
		</td>
</tr>
<tr>
...
?>
	...
	<?php
		$query = "select *from ncir_correction_type where idCor = '$r[idCor]'";
			...
			$checked= $check_list;
$jk = mysqli_query($conn, "select *from mjeniskoreksi order by idKoreksi ASC");
while($j = mysqli_fetch_array($jk)){
	$checked= $check_list;
	?>
	<input type='checkbox' name='jenis_koreksi[]' value="<?php echo $j[jenisKoreksi]; ?>" style='height:16px;width:16px;background-color:none' <?php in_array ($j[jenisKoreksi], $checked) ? print "checked" : ""; ?> disabled=''>&nbsp;<?php echo $j[jenisKoreksi];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php
}
	?>
	</tr>
	...
	<tr><td width='1%'><font size='2'>1. Hasil Baik</font></td><td width='1%'>:</td><td  colspan='3' ><?php echo $r[hasil_baik]; ?></td></tr>
