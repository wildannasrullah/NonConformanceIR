...
$a = mysqli_query($conn, "select *from ncar ni left join ncar_correction nc on ni.ncarCode=nc.ncarCode left join ncar_correction_type nct on nc.idCorNcar=nct.idCorNcar  left join departemen d on ni.idDepart=d.idDepart where ni.ncarCode='$_GET[no]'");
...
<h5>DETAIL REPORT NCAR</h5><br><br>
</div>
<?php
...
<td colspan='4'>
	...
	<?php
		$query = "select *from ncar_correction_type where idCorNcar = '$r[idCorNcar]'";
